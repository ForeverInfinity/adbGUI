...
namespace adbGUI.Forms
{
    public partial class MainForm : Form
    {
        ...
        private const int RICHTEXTBOX_REFRSH_INTERVAL = 5;
        ...
        private void Tsb_AlwayClearConsole_CheckedChanged(object sender, EventArgs e)
        {
            ...
            HelperClass.AlwaysClearConsole = checkState;
            ((ToolStripButton)sender).ForeColor = checkState ? SystemColors.HotTrack : SystemColors.ControlText;
        }
    }
}
